...
public class DeleteDevice {
	...
	public void deleteDevice(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String apiName = "/data/json/device/" + deleteParams.getObjectID();
		//String jsonString = MatrixxUtility.getJSONPayload(payload).toString();
		logger.info("URL :: {} :::: Payload :: {}", (connection.getBaseURL() + apiName));
		...
		RestRequestBuilder builder = new RestRequestBuilder(connection.getBaseURL(), apiName,
