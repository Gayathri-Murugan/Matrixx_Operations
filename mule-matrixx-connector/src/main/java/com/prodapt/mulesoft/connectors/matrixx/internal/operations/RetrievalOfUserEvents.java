...
public class RetrievalOfUserEvents {


	private static final Logger logger = LoggerFactory.getLogger(RetrievalOfUserEvents.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Retrieval of UserEvents")
	@MediaType(value = "application/json")
	@Summary("This method is used to search for events in the MATRIXX in-memory database and retrieve information on events associated with the user")
	public void retrievalofUserEvents(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String resourcePath = "/data/json/user/" + deleteParams.getObjectID()+ "/events";
