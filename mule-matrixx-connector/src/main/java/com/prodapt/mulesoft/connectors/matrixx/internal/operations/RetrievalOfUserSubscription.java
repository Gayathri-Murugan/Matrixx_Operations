...
public class RetrievalOfUserSubscription {

	
	private static final Logger logger = LoggerFactory.getLogger(RetrievalOfUserSubscription.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Retrieval of UserSubscription")
	@MediaType(value = "application/json")
	@Summary("This service implements the retrieval of the subscriptions with which this user is associated.")
	public void retrievalofUserSubscription(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String resourcePath = "/data/json/user/" + deleteParams.getObjectID()+ "/subscriptions";
